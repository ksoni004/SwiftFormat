...
extension RulesTests {
    ...
    static let __allTests__RulesTests = [
        ...
        ("testSortedSwitchWhereCondition", testSortedSwitchWhereCondition),
        ...
        ("testUpdatesExtensionThatHasDifferentACLFromBodyDeclarations", testUpdatesExtensionThatHasDifferentACLFromBodyDeclarations),
